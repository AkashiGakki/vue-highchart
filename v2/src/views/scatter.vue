<template>
    <div class="scatter">
        <v-chart :config="confScatter1"></v-chart>
        <v-chart :config="confScatter2"></v-chart>
        <v-chart :config="confScatter3"></v-chart>
        <v-chart :config="confScatter4"></v-chart>
        <v-chart :config="confScatter5"></v-chart>
        <v-chart :config="confScatter6"></v-chart>
    </div>
</template>
